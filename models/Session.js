...
const sessionSchema = new Schema({
    ...
    // Allow IPv4, IPv6 loopback, localhost, and IPv4-mapped IPv6 (::ffff:x.x.x.x)
    match: /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$|^([0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4}$|^::1$|^127\.0\.0\.1$|^::ffff:(?:[0-9]{1,3}\.){3}[0-9]{1,3}$/
    },
    user_agent: {
    type: String
    },
